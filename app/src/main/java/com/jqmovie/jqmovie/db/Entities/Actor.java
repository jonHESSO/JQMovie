...
public class Actor {
    ...
    public static List<Actor> populateData()
    {
        ...
        actorList.add(new Actor("7","Matthew","McConaughey", "04.11.1969", "Matthew McConaughey was born on November 4, 1969, in Uvalde, Texas. He graduated from the University of Texas at Austin and got his first big break with the 1993 film Dazed and Confused. He later starred in A Time to Kill (1996) and Amistad (1997), among many others. Named People magazine's \"Sexiest Man Alive\" in 2005, McConaughey more recently starred in Mud (2012) and Dallas Buyers Club (2013), which earned him the Academy Award for Best Actor. McConaughey came on strong in 2014 with his starring role on the HBO series True Detective, a project that propelled him even further on his star trajectory.","mcconaughey")) ;
        actorList.add(new Actor("8","Jessica","Chastain", "24.04.1977", "Born on March 24, 1977, in Sacramento, California, Jessica Chastain attended Juilliard and then began landing roles on TV shows such as ER and Veronica Mars. Her acting career took off in 2011 when she appeared in the blockbuster The Help, earning a supporting actress Oscar nod for the role, and the lauded Tree of Life. She has since won a Golden Globe and earned another Academy Award nomination, specifically for lead actress in the Kathryn Bigelow film Zero Dark Thirty. Additional projects include Interstellar, A Most Violent Year and Crimson Peak.","chastain")) ;
