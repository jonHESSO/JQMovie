...
public class Movie {
    ...
    public static List<Movie> populateData()
    {
        ...
        movieList.add(new Movie(3,"Interstellar","2014","Science-Fiction","The film tells the adventures of a group of explorers who use a recently discovered rift in space-time to push human limits and conquer astronomical distances in an interstellar journey.", R.mipmap.interstellar,3,6)) ;
        return movieList ;
